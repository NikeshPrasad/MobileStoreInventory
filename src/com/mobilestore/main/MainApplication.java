		...
		do {
			...
			*/
			...
			case 1:	Mobile mobile = new Mobile();
					...
					if(result.length() == 6) System.out.println(mobile.getMobileName() + " added to stock with id: " + result);
			...
			case 4:	salesReport = admin.getSalesReport();
					...
					System.out.printf("| %-12s | %-12s | %-12s | %-12s | %-22s | %-14s | %-16s | %-18s | %-16s | %-16s |%n", 
							"Sales ID", "Sales Date", "Brand", "Mobile Id", "Mobile Name", "Quantity sold", "Price/unit", "Sales price/unit", "Profit/unit", "Total profit");
					
					while(iter.hasNext()) {
						SalesReport sr = iter.next();
						System.out.printf("| %-12s | %-12s | %-12s | %-12s | %-22s | %14d | %16.2f | %18.2f | %16.2f | %16.2f |%n",
								sr.getSalesID(), dateFormat.format(sr.getSalesDate()), sr.getBrand(), sr.getMobileId(), sr.getMobileName(),
								sr.getQuantitySold(), sr.getUnitPrice(), sr.getSalesPricePerUnit(), sr.getProfitPerUnit(), sr.getTotalProfit());
					}
					break;
